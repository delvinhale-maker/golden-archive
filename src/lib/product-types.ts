...
export const PRODUCT_TYPES: Record<ProductTypeKey, ProductTypeConfig> = {
  ...
  ai_prompt_pack: {
    ...
    fileExts: ["pdf", "txt", "json", "docx"],
    fileMimes: ["application/pdf", "text/plain", "application/json", OFFICE_DOCX],
    acceptString: ".pdf,.txt,.json,.docx,application/pdf,text/plain,application/json," + OFFICE_DOCX,
    acceptedHint: ".PDF, .TXT, .JSON, .DOCX",
    suggestedPriceCents: 999,
    accent: "#1A3A8F",
    isEbook: false,
  },
  ...
  business_operating_system: {
    ...
    emoji: "⚙️",
    tagline: "Complete business system (PDF, DOCX, or ZIP)",
  ...
  caption_template: {
    ...
    emoji: "💬",
    tagline: "Done-for-you caption collection (PDF or DOCX)",
    category: "caption_templates",
    categoryLabel: "Caption Templates",
    fileExts: ["pdf", "docx"],
    fileMimes: ["application/pdf", OFFICE_DOCX],
    acceptString: ".pdf,.docx,application/pdf," + OFFICE_DOCX,
    acceptedHint: ".PDF or .DOCX",
