...
const NAV_ITEMS: { label: string; to: string; featured?: boolean; creatorStudio?: boolean }[] = [
  ...
  // Fail-closed: only rendered once CREATOR_STUDIO_ENABLED is on. This is a
  // UI convenience, not the real gate -- every Creator Studio server
  // function independently re-checks the flag server-side.
