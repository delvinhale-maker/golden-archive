    ...
    <div className="min-h-screen bg-paper">
      ...
      <header className="bg-navy text-white">
        <div className="mx-auto max-w-6xl px-4 md:px-8 py-4 flex items-center gap-4">
          ...
          <Link to="/admin/payouts" className="text-sm text-white/70 hover:text-white">Payouts</Link>
          <Link to="/admin/earnings" className="text-sm text-white/70 hover:text-white">Earnings</Link>
