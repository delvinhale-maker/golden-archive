...
const POINTS = [
  ...
  "You keep 85% of every sale; AurumVault retains 15% to operate the platform.",
        ...
        <div className="mt-10 space-y-8 text-ink/80 leading-relaxed">
          <section>
            ...
            <p className="mt-2 text-sm">
              AurumVault charges a 15% platform fee on each sale. The creator
              receives 85% of the gross transaction amount, less payment processing
          ...
          <section>
            ...
            <p className="mt-2 text-sm">
              Seller questions:{" "}
              <a
                href="mailto:creators@supportaurumvault.tech"
                className="text-navy hover:text-gold-ink hover:underline"
              >
                creators@supportaurumvault.tech
              </a>
              .
            </p>
          </section>
