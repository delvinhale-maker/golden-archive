...
const TOPICS = [
  ...
  },
  {
    ...
    body: "Sellers keep 91% of every sale. Upload your ebook, cover, and manuscript in the publisher dashboard. Payouts are processed on the schedule shown in your dashboard.",
  },
  {
    icon: Mail,
